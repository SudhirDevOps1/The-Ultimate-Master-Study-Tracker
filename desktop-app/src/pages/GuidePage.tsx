...
export function GuidePage() {
  ...
  const appInfo = {
    ...
    version: "v7.5.0 (Latest 2026 Release)",
  ...
  const tabs = [
    ...
    { id: "fixes", label: "✨ New in v7.5.0", icon: <CheckCircle2 className="w-4 h-4 text-emerald-400" /> },
  ...
  const openSourceCredits = [
    ...
    { name: "Electron 43", url: "https://www.electronjs.org", desc: "Cross-platform desktop runtime packaging Chromium & Node.js", type: "Desktop Runtime" },
    ...
    { name: "C# Win32 Active Tracker", url: "https://learn.microsoft.com/en-us/windows/win32/", desc: "Low-overhead C# native executable for Windows active window process tracking", type: "OS Process Tracker" },
    ...
    { name: "electron-updater 6.8", url: "https://www.electron.build/auto-update", desc: "Silent background updates via GitHub Releases", type: "Auto-Updater" },
  ];
