...
import { HelpCircle, X, Send, Mail, User, MessageSquare, ShieldCheck, CheckCircle2 } from "lucide-react";
      ...
      <AnimatePresence>
        {isOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md">
            ...
            >
              {/* Header */}
              <div className="p-6 border-b border-white/5 bg-gradient-to-br from-indigo-500/10 via-cyan-500/10 to-transparent flex items-center justify-between">
                <div>
                  <h2 className="text-2xl font-black text-white flex items-center gap-2">
                    📬 Contact Us & Support
                  </h2>
                  <p className="text-xs text-indigo-300 font-medium mt-0.5">
                    Have questions or feedback? Send us a direct message!
                  </p>
                </div>
                <button
              ...
              <div className="p-6 space-y-4">
                {isSubmitted ? (
                  ...
                  <form
                    method="POST"
                    action="https://apnaform.sudhirdevops1.workers.dev/api/submit/endpoint_qZ23VhUEkXnmi3zMeBdT8Qs9"
                    onSubmit={() => {
                  ...
                  >
                    ...
                    <button
                      type="submit"
                      className="w-full flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-cyan-500 py-3 text-sm font-bold text-white shadow-lg shadow-indigo-500/25 hover:opacity-95 transition-all hover:scale-[1.01] active:scale-[0.99] mt-2"
                    >
              ...
              {/* Footer */}
              <div className="p-4 bg-slate-950/50 border-t border-white/5 flex items-center justify-between text-xs text-slate-400 px-6">
