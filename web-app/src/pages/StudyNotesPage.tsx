    ...
    >
      <div className="rounded-3xl bg-slate-900/40 p-6 border border-white/5 shadow-2xl backdrop-blur-xl">
        ...
        <p className="mt-2 text-sm text-slate-400 max-w-2xl leading-relaxed">
          Open textbook PDFs or Images to perform local Tesseract OCR. Convert text layers, format with custom styles, highlight terms, listen with Speech synthesis, and export beautiful sticky notes easily.
        </p>
      </div>
