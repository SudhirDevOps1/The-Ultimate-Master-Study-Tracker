      ...
      <div className="rounded-2xl border border-purple-500/30 bg-gradient-to-r from-purple-950/40 via-indigo-950/40 to-slate-900/60 p-4 shadow-xl flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono text-cyan-400 font-bold">v7.5.1</span>
          </div>
        ...
        <a
          href="https://github.com/SudhirDevOps1/The-Ultimate-Master-Study-Tracker/releases/tag/v7.5.1"
          target="_blank"
...
function WelcomeChangelogModal() {
  ...
  useEffect(() => {
    ...
    const seenVersion = localStorage.getItem("flowtrack_changelog_v7.5.1");
    if (!seenVersion) {
      setIsOpen(true);
    }
  }, []);
  ...
  const handleClose = () => {
    localStorage.setItem("flowtrack_changelog_v7.5.1", "true");
    setIsOpen(false);
  };
          ...
          >
            <div className="space-y-1">
              ...
              <h3 className="text-2xl font-black text-white">
                What&apos;s New in FlowTrack Pro v7.5.1!
              </h3>
              <p className="text-xs text-slate-400">
