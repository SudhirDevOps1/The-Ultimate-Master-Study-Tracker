...
import { HelpCircle, X, Send, Mail, User, MessageSquare, ShieldCheck, CheckCircle2, AlertCircle, Loader2 } from "lucide-react";
                ...
                {status === "success" ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-cyan-500 py-3 text-sm font-bold text-white shadow-lg shadow-indigo-500/25 hover:opacity-95 transition-all hover:scale-[1.01] active:scale-[0.99] mt-2 disabled:opacity-50"
                    >
                      {status === "submitting" ? (
                        <>
